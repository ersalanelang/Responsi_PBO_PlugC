...
import responsi.Edit;

/**
 *
 * @author Asus
 */
public class EditBarang_GUI {
  ...
  JButton btnKembali = new JButton("Kembali");
    ...
    public EditBarang_GUI(Barang b) {
...
// sett bounds(m,n,o,p) >>> (sumbu-x,sumbu-y,panjang komponen, tinggi komponen)
        btnEdit.setBounds(180, 160, 100, 30);
...
// ACTION LISTENER
        btnEdit.addActionListener((var arg0) -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "harus angka bree", "Pesan Kesalahan", JOptionPane.INFORMATION_MESSAGE);
            }
        });
